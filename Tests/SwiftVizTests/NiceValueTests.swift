...
class NiceValueTests: XCTestCase {
    ...
    func testDoubleNiceRange() throws {
        ...
        try verifyRangeAttributes(min: min, max: max, steps: 70, calcSteps: 63, stepsize: 0.2, niceMax: 12.4)
        try verifyRangeAttributes(min: min, max: max, steps: 80, calcSteps: 63, stepsize: 0.2, niceMax: 12.4)
        try verifyRangeAttributes(min: min, max: max, steps: 90, calcSteps: 63, stepsize: 0.2, niceMax: 12.4)
        try verifyRangeAttributes(min: min, max: max, steps: 100, calcSteps: 63, stepsize: 0.2, niceMax: 12.4)
        try verifyRangeAttributes(min: min, max: max, steps: 110, calcSteps: 63, stepsize: 0.2, niceMax: 12.4)
        try verifyRangeAttributes(min: min, max: max, steps: 120, calcSteps: 63, stepsize: 0.2, niceMax: 12.4)
        try verifyRangeAttributes(min: min, max: max, steps: 130, calcSteps: 126, stepsize: 0.1, niceMax: 12.5)
        try verifyRangeAttributes(min: min, max: max, steps: 140, calcSteps: 126, stepsize: 0.1, niceMax: 12.5)
        try verifyRangeAttributes(min: min, max: max, steps: 150, calcSteps: 126, stepsize: 0.1, niceMax: 12.5)
        try verifyRangeAttributes(min: min, max: max, steps: 160, calcSteps: 126, stepsize: 0.1, niceMax: 12.5)
        try verifyRangeAttributes(min: min, max: max, steps: 170, calcSteps: 126, stepsize: 0.1, niceMax: 12.5)
        try verifyRangeAttributes(min: min, max: max, steps: 180, calcSteps: 126, stepsize: 0.1, niceMax: 12.5)
        try verifyRangeAttributes(min: min, max: max, steps: 190, calcSteps: 126, stepsize: 0.1, niceMax: 12.5)
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 180))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 170))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 160))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 150))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 140))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 130))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 120))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 110))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 100))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 90))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 80))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 70))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 60))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 50))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 40))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 30))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 20))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 19))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 18))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 17))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 16))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 15))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 14))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 13))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 12))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 11))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 10))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 9))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 8))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 7))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 6))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 5))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 4))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 3))
        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 2))
//        print(Double.rangeOfNiceValues(min: 0.1, max: 12.56, ofSize: 1))
    }
}
