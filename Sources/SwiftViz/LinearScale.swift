...
public struct LinearScale: Scale {
    ...
    public init(domain: ClosedRange<Double>, isClamped: Bool = false) {
...
//    }
    ...
    public func scale(_ inputValue: Double, range: ClosedRange<Double>) -> Double {
    ...
    public func invert(_ outputValue: Double, range: ClosedRange<Double>) -> Double {
